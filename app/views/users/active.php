...
<div class="card shadow">
    <div class="card-header bg-transparent">
        <h3 class="mb-0">Activar Usuario </h3>
    </div>
    ...
    <div class="card-body">
      <div class="alert alert-success">
        ...
        <form action="<?php echo ROUTE_URL?>/users/active/<?php echo $parameters['user']->idusuario?>" method="post" id="form-active">
                <div class="row">
                    <div class="col-md-6">
              ...
              <!-- Errores JS -->
                <div class="row">
                 ...
                 <input type="submit" class="btn btn-success" name="guardar" value="Activar">
