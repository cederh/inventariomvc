                       ...
                       <label for="">Sexo</label>
                        <div class="form-group form-inline">
                            <div class="custom-control custom-radio mb-3 form-check-inline">
                                <input name="genero" class="custom-control-input" id="hombre" disabled value="1" type="radio" <?php echo $var = ($parameters['user']->usu_genero == 1)?'checked':''?>>
                                <label class="custom-control-label" for="hombre">Hombre</label>
                            </div>
                            <div class="custom-control custom-radio mb-3 form-check-inline">
                                <input name="genero" class="custom-control-input" id="mujer" disabled value="2" type="radio" <?php echo $var = ($parameters['user']->usu_genero == 2)?'checked':''?>>
                        ...
                        <div class="form-group form-inline">
                            <div class="custom-control custom-radio mb-3 form-check-inline">
                                <input name="user_type" class="custom-control-input" id="estandar" value="1"
                                    type="radio" <?php echo $var = ($parameters['user']->usu_tipo == 1)?'checked':''?> disabled>
                            ...
                            <div class="custom-control custom-radio mb-3 form-check-inline">
                                <input name="user_type" class="custom-control-input" id="admin" value="2"
                                    type="radio" <?php echo $var = ($parameters['user']->usu_tipo == 2)?'checked':''?> disabled>
