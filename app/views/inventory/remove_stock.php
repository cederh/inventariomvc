...
<div class="card shadow">
    <div class="card-header bg-transparent">
        <h3 class="mb-0">Disminuir Stock </h3>
    </div>
   ...
   <div class="card-body">
      <form action="<?php echo ROUTE_URL?>/inventory/remove_stock/<?php echo $parameters["inventory"]->idproducto ?>" method="post" id="form-add_stock">
