...
<div class="card shadow">
    ...
    <div class="card-body">
      <form action="<?php echo ROUTE_URL?>/providers/update_provider/<?php echo $parameters['providers']->idproveedor ?>" method="post" id="form-usuario">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        <label for="descripcion">Descripcion</label>
                           ...
                           name="descripcion" placeholder="Descripcion" ><?php echo $parameters['providers']->descripcion?>
                           </textarea>
                     </div>
                  </div>
               </div>
